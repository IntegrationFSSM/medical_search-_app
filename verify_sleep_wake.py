...
def verify_sleep_wake_html_paths():
    """Verify html_page paths in Sleep_Wake_Disorders_out (with subdirectories)."""
    
    base_folders = [
        "Embedding/Sleep_Wake_Disorders_out",
        "Embedding_Gemini_3072/Sleep_Wake_Disorders_out",
        "Embedding_OpenAI_3072/Sleep_Wake_Disorders_out"
    ]
    
    print("=" * 80)
    print("VERIFICATION - SLEEP-WAKE DISORDERS (avec sous-dossiers)")
    print("=" * 80)
    print()
