...
def verify_personality_html_paths():
    """Verify html_page paths in Personality_Disorders_out (with subdirectories)."""
    
    base_folders = [
        "Embedding/Personality_Disorders_out",
        "Embedding_Gemini_3072/Personality_Disorders_out",
        "Embedding_OpenAI_3072/Personality_Disorders_out"
    ]
    
    print("=" * 80)
    print("VERIFICATION - PERSONALITY DISORDERS (avec sous-dossiers)")
    print("=" * 80)
    print()
